...
- Return value of getDigestEmailRecipient\_() - This function returns a string that is the email address of the recipient (or a comma-separated list of email addresses of recipients). I put this value here because it's a private function that shouldn't be visibile to clients under any circumstance.  
